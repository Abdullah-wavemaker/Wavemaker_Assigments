...
function showEditTaxesBox(){
  var url = "http://localhost:8080/RestuarantBilling/taxes/1"
    ...
    .then((json) =>{
      ...
      showCancelButton: true,
      html:
        '<label><b>CGST %:</b></label><input id="cgst" class="swal2-input" placeholder="CGST" value="' +
        json["cgst"]+
        '"><br>' +
        '<label><b>SGST %:</b></label><input id="sgst" class="swal2-input" placeholder="SGST" value="' +
        json["sgst"] +
        '"><br>' +
        '<label><b>Other %:</b></label><input id="convfee" class="swal2-input" placeholder="Convinience Fee" value="' +
